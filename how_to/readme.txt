...
консоль в папке проекта: npm i express serve-favicon body-parser cookie-parser express-session express-react-view express-react-engine react react-dom winston pg(модули для разработки фронта и бэка, часть нужна для запуска базового проекта, созданного экспрессом)
